...
#         sentences_zh, words_zh = await self._create_sentence_word_entries(
#             lines_zh, full_zh_text, "zh", video.id, session
#         )
#
#         lines_en = lines_dict['en']
#         sentences_en, words_en = await self._create_sentence_word_entries(
...
#         await session.flush()
#
#         for sentence_id, word_entry in word_objects:
#             print("---", sentence_id, word_entry.word, "\n")
#
#         for sentence_id, sent in sentences.items():
#             print("---", sentence_id, sent, "\n")
#
